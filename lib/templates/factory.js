...
const command_1 = require("./factory/command");
const template_1 = require("./factory/template");
...
Next steps:
  ...
  $ ${this.style.cyan('fbi list')} ${this.style.dim(`the factory "${project.name}" should be listed in the "available factories"`)}
