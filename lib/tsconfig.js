...
const getTsConfig = (cwd = process.cwd()) => {
    ...
    const typesPaths = modulesPaths
        ...
        .concat(['types/*']);
    return Object.assign(Object.assign(Object.assign({}, base_json_1.default), userConfig), { compilerOptions: Object.assign(Object.assign(Object.assign({}, base_json_1.default.compilerOptions), userConfig.compilerOptions), { paths: {
                '*': typesPaths
